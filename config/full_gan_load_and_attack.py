...
class Global(MrDict):
    ...
    model = "load_and_attack"
    exp_name = os.environ.get("exp_name", "full_gan-load_and_attack")
    ...
    resume_trainer = "$ROOT/Project/Homomorphic-Obfuscation/../work/12.25_20:37-full_gan-simpler_attacker/save_every-44.ptr"
