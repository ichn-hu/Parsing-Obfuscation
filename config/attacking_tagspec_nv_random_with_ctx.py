...
class GlobalOnBuccleuch(config.GlobalOnBuccleuch, Global):
    ...
    obf_model = "alltag_random"
    atk_model = "ctx"
    exp_name = "attacking_tagspec_nv_random_with_ctx"
    ...
    resume_trainer = None
    resume_attacker = "$ROOT/Project/buccleuch/work/12.08_00:40-attacking_tagspec_nv_random_with_ctx/best-epoch-43.ptr"
