...
class GlobalOnBuccleuch(config.GlobalOnBuccleuch, Global):
    ...
    obf_model = "seqlabel"
    atk_model = "ctx"
    exp_name = "attacking_seqlabel_strthr_NE_with_ctx"
    ...
    resume_trainer = None
    resume_attacker = "$ROOT/Project/buccleuch/work/12.02_16:48-attacking_seqlabel_strthr_NE_with_ctx/trainer-64.ptr"
