...
@Model.register("pretrained_biaffine_parser")
class PretrainedBiaffineDependencyParser(Model):
    """
    ...
    def __init__(self,
        ...
        super(PretrainedBiaffineDependencyParser, self).__init__(vocab, regularizer)
    ...
    def forward(self,  # type: ignore
        ...
        if "input_embedding" in words.keys():
            embedded_text_input = words["input_embedding"]
        else:
